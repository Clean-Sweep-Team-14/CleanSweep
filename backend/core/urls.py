...
urlpatterns = [
    ...
    path('chores/medium/', views.MediumChoreList.as_view(),
         name='medium-chore-list'),
    ...
    path('chores/tracker/<int:pk>/', views.ChoreTrackerUpdate.as_view(),
         name='chore-tracker-update'),
    ...
    # Leaderboards
    path('leaderboard/global/', views.GlobalLeaderboard.as_view(),
         name='gobal-leaderboard'),
    path('leaderboard/friends/', views.FriendsLeaderboard.as_view(),
